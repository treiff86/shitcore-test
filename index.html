...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;700&family=MedievalSharp&family=UnifrakturMaguntia&family=Baloo+2:wght@500;700;800&display=swap" rel="stylesheet">
    <!-- FontAwesome icons -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <!-- Local styles (FIXED PATH) -->
    <link rel="stylesheet" href="style.css?v=29">
    <link rel="stylesheet" href="bonusstage.css?v=1">
</head>
<body class="overflow-x-hidden min-h-screen flex flex-col justify-between">
    ...
    <header class="bg-[#090C12] border-b border-[#1A2232] px-4 py-3 sticky top-0 z-50 shadow-md">
        <audio id="bgMusicEl" src="assets/midevil-theme.mp3" loop preload="none"></audio>
        <div class="max-w-7xl mx-auto flex items-center justify-between gap-3 flex-wrap">
            <div class="flex items-center space-x-3">
                <button id="audioToggleBtn" onclick="toggleBgMusic()" title="Toggle background music" class="bg-gradient-to-tr from-amber-600 to-amber-950 p-2 rounded-lg shadow-lg hidden sm:flex">
            ...
            <div class="flex items-center gap-3 flex-wrap text-xs md:text-sm">
                ...
                <button id="resetGameBtn" title="Wipe save and start over" class="text-gray-500 hover:text-rose-400 transition text-xs border border-[#1A2232] rounded px-2 py-1.5">
    ...
    <main class="max-w-7xl mx-auto px-4 py-6 flex-grow w-full">
        ...
        <section id="content-markets" class="space-y-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 bg-[#0C0F16] border border-[#1A2232] rounded-xl p-5 flex flex-col justify-between shadow-lg">
                    <div>
                ...
                <div class="bg-[#0C0F16] border border-[#1A2232] rounded-xl p-5 flex flex-col justify-between shadow-lg space-y-4">
                    <div>
            ...
            <div class="bg-[#0C0F16] border border-[#1A2232] rounded-xl p-4 shadow-lg">
    ...
    <section class="max-w-7xl mx-auto px-4 pb-6 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-[#0C0F16] border border-[#1A2232] rounded-xl p-5 shadow-lg space-y-5">
                <div>
        ...
        <!-- Victim leaderboard -->
        <div class="bg-[#0C0F16] border border-[#1A2232] rounded-xl p-5 shadow-lg mt-6">
